...
int serializeDbMetadata(IsarWriter writer, DbMetadata object) {
  ...
  IsarCore.writeString(writer, 6, object.displayName);
  IsarCore.writeString(writer, 7, object.picture);
  IsarCore.writeString(writer, 8, object.banner);
  IsarCore.writeString(writer, 9, object.website);
  IsarCore.writeString(writer, 10, object.about);
  IsarCore.writeString(writer, 11, object.nip05);
  IsarCore.writeString(writer, 12, object.lud16);
  IsarCore.writeString(writer, 13, object.lud06);
  IsarCore.writeLong(writer, 14, object.createdAt);
  IsarCore.writeBool(writer, 15, object.isDeleted);
  IsarCore.writeLong(
      writer, 16, object.refreshedTimestamp ?? -9223372036854775808);
  {
...
DbMetadata deserializeDbMetadata(IsarReader reader) {
  ...
  _createdAt = IsarCore.readLong(reader, 14);
  final bool _isDeleted;
  _isDeleted = IsarCore.readBool(reader, 15);
...
class _DbMetadataUpdateImpl implements _DbMetadataUpdate {
  ...
  bool call({
    ...
    return collection.updateProperties([
          ...
          if (createdAt != ignore) 14: createdAt as int?,
          if (isDeleted != ignore) 15: isDeleted as bool?,
          if (refreshedTimestamp != ignore) 16: refreshedTimestamp as int?,
...
extension DbMetadataQueryFilter
  ...
  QueryBuilder<DbMetadata, DbMetadata, QAfterFilterCondition> createdAtEqualTo(
    int value,
  ) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
  ...
  QueryBuilder<DbMetadata, DbMetadata, QAfterFilterCondition> createdAtLessThan(
    int value,
  ) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
  ...
  QueryBuilder<DbMetadata, DbMetadata, QAfterFilterCondition> createdAtBetween(
    int lower,
    int upper,
  ) {
    return QueryBuilder.apply(this, (query) {
...
extension DbMetadataQuerySortBy
  ...
  QueryBuilder<DbMetadata, DbMetadata, QAfterSortBy> sortByCreatedAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(14);
    });
  }

  QueryBuilder<DbMetadata, DbMetadata, QAfterSortBy> sortByCreatedAtDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension DbMetadataQuerySortThenBy
  ...
  QueryBuilder<DbMetadata, DbMetadata, QAfterSortBy> thenByCreatedAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(14);
    });
  }

  QueryBuilder<DbMetadata, DbMetadata, QAfterSortBy> thenByCreatedAtDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(14, sort: Sort.desc);
    });
  }
...
extension DbMetadataQueryWhereDistinct
  ...
  QueryBuilder<DbMetadata, DbMetadata, QAfterDistinct> distinctByCreatedAt() {
    return QueryBuilder.apply(this, (query) {
...
extension DbMetadataQueryProperty1
  ...
  QueryBuilder<DbMetadata, int, QAfterProperty> createdAtProperty() {
    return QueryBuilder.apply(this, (query) {
...
extension DbMetadataQueryProperty2<R>
  ...
  QueryBuilder<DbMetadata, (R, int), QAfterProperty> createdAtProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addProperty(14);
    });
  }
...
extension DbMetadataQueryProperty3<R1, R2>
  ...
  QueryBuilder<DbMetadata, (R1, R2, int), QOperations> createdAtProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addProperty(14);
    });
  }
